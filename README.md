...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C918%20rows-8250df">
...
> **Important:** this repository is a **public 8,918-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,621,982 domains** on the canonical page below.

**Public extract:** 8,918 rows · **Live catalog:** 5,621,982 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/rip?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_rip_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/rip?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_rip_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./rip.csv">CSV</a> / <a href="./rip.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_rip_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_rip_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .RIP search](https://unique.domains/domains/tld/rip?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_rip_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .RIP search](https://unique.domains/domains/tld/rip?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_rip_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./rip.csv) or [Download JSON](./rip.json)
...
- `rip.csv` — public CSV extract (8,918 rows)
- `rip.json` — public JSON extract (8,918 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,918-row public sample | 5,621,982 live domains                           |
...
| water.rip    | available | $32.98    | —             | 108            | 45     | 5      | namecheap                                                 |
| code.rip     | resell    | —         | —             | 72             | 64     | 4      | Global Domains International, Inc. DBA DomainCostClub.com |
...
> Unique Domains. *Available .RIP One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
